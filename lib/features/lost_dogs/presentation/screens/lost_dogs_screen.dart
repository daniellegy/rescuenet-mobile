	...
	List<LostDogPost> _ordenarPosts(List<LostDogPost> posts) {
		...
		switch (_ordenActual) {
			...
			case LostDogSort.porEstado:
				lista.sort((a, b) => b.estadoColor.value.compareTo(a.estadoColor.value));
				break;
		}
				...
				slivers: [
					...
					SliverToBoxAdapter(
						child: Padding(
							...
							child: Row(
								children: [
									_buildStatCard('Activos', '${postsOrdenados.length}', Colors.red),
											...
											child: Container(
												...
												child: ListTile(
													...
													leading: CircleAvatar(
														radius: 28,
														backgroundColor: post.estadoColor.withValues(alpha: 0.12),
													...
													subtitle: Padding(
														...
														child: Column(
															...
															children: [
																...
																const SizedBox(height: 4),
																Text('Publicado ${post.timeAgo} • Estado: ${post.estado}'),
																if (post.reward != null) ...[
																	const SizedBox(height: 4),
																	Text(post.reward!),
																],
																...
																return Padding(
																	...
																	child: Column(
																		...
																		children: [
																			...
																			const SizedBox(height: 8),
																			Text('Contacto: ${post.contact ?? 'Pendiente'}'),
																			const SizedBox(height: 8),
